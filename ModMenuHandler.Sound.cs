    ...
    public partial class ModMenuHandler
    {
        ...
        private List<ModMenuItem> BuildSoundItems()
        {
            ...
            return new List<ModMenuItem>
            {
                ...
                Toggle("mod_menu_label_gauge_level_beep",
                    () => ModSettings.BonusGaugeLevelBeepEnabled,
                    v => ModSettings.BonusGaugeLevelBeepEnabled = v),
                Toggle("mod_menu_label_gauge_break_sound",
                    () => ModSettings.BonusGaugeBreakSoundEnabled,
                    v => ModSettings.BonusGaugeBreakSoundEnabled = v),
                ...
                Toggle("mod_menu_label_gauge_level_announce",
                    () => ModSettings.BonusGaugeLevelAnnounceEnabled,
                    v => ModSettings.BonusGaugeLevelAnnounceEnabled = v),
