...
- World map navigation — pathfinding auto-walk or spoken directions to towns, dungeons, undiscovered landmarks and fishing spots across the world map, on both planets (Expel and Nede), with honest feedback when a destination cannot be reached on foot or by bunny. On Nede only the Centropolis and North City connect by land; the rest of the planet is meant to be flown to.
